...
from Modules.update_drivers import update_all_drivers
...
class BannerArgumentParser(argparse.ArgumentParser):
    """imprime el BANNER antes de la ayuda."""
...
if __name__ == '__main__':
    ...
    update_group.add_argument("-up", "--update",action="store_true", help="Actualizar herramienta")
    update_group.add_argument("-upd" ,"--update-drivers", action="store_true", help="Actualizar Chromedriver para Win y Linux")
    ...
    # 2) Update tool and chromedriver
